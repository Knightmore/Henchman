...
public class HuntMark
{
    ...
    public HuntMark(MobSpawnPoint spawnPoint)
    {
        BNpcNameRowId = spawnPoint.BNpcNameRowId;
        Positions     = new List<Vector3>(spawnPoint.Positions);
        TerritoryId   = spawnPoint.TerritoryId;
        FateId        = spawnPoint.FateId;
        Level         = spawnPoint.Level;
    }
