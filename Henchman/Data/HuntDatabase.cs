...
internal static class HuntDatabase
{
    ...
    internal static readonly Dictionary<string, string> BillCategories = new()
                                                                         {
                                                                                 ...
                                                                                 {
                                                                                         HuntBoardOptions[0], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                 .GetRow(2001361)
                                                                                                                 .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[1], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                 .GetRow(2001362)
                                                                                                                 .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[2], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                 .GetRow(2001700)
                                                                                                                 .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[3], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                 .GetRow(2001701)
                                                                                                                 .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[4], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                 .GetRow(2001702)
                                                                                                                 .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[5], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                 .GetRow(2001703)
                                                                                                                 .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[6], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                 .GetRow(2002113)
                                                                                                                 .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[7], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                 .GetRow(2002114)
                                                                                                                 .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[8], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                 .GetRow(2002115)
                                                                                                                 .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[9], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                 .GetRow(2002116)
                                                                                                                 .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[10], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                  .GetRow(2002628)
                                                                                                                  .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[11], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                  .GetRow(2002629)
                                                                                                                  .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[12], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                  .GetRow(2002630)
                                                                                                                  .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[13], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                  .GetRow(2002631)
                                                                                                                  .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[14], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                  .GetRow(2003090)
                                                                                                                  .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[15], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                  .GetRow(2003091)
                                                                                                                  .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[16], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                  .GetRow(2003092)
                                                                                                                  .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[17], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                  .GetRow(2003093)
                                                                                                                  .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[18], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                  .GetRow(2003509)
                                                                                                                  .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[19], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                  .GetRow(2003510)
                                                                                                                  .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[20], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                  .GetRow(2003511)
                                                                                                                  .Name.ExtractText()
                                                                                 },
                                                                                 {
                                                                                         HuntBoardOptions[21], Svc.Data.GetExcelSheet<EventItem>()
                                                                                                                  .GetRow(2003512)
                                                                                                                  .Name.ExtractText()
                                                                                 }
                                                                         };
    ...
    internal static HuntMark? GetHuntMarkForExpansion(uint bnpcNameRowId, uint exVersionRowId) => GetHuntMarksByName(bnpcNameRowId)
    ...
    internal static HuntMark ResolveBestLevelVariant(HuntMark source, int playerLevel, bool useLowest = true, bool preferOverworldNonFate = false)
    {
        ...
        var preferredCandidates = preferOverworldNonFate
                                          ? candidates.Where(x => x is { IsDuty: false, FateId: 0 })
                                                      .ToList()
        ...
        return CreateProgressVariant(best, source);
    }

    internal static HuntMark CreateProgressVariant(HuntMark variant, HuntMark source) => new(variant)
                                                                                         {
    ...
    private static HuntMark? SelectBestLevelVariant(List<HuntMark> candidates, int playerLevel, bool useLowest)
    {
        var leveledCandidates = candidates.Where(x => x.Level != null)
                                          .ToList();
        return (useLowest
                        ? leveledCandidates.OrderBy(x => x.Level)
                                           .FirstOrDefault()
    ...
    internal static async Task PopulateMarks()
    {
        try
        {
            HuntMarks = MobLocationDatabase.AllSpawnPoints.Select(x => new HuntMark(x))
                                           .ToList();
            BRanks = MobLocationDatabase.EliteMarkSpawnPoints.Select(x => new HuntMark(x))
                                        .ToList();
